        ...
        {isSubmit ? (
          <div className="box">
            ...
            <div className="rating">
              {ratings.map((isHovered, index) => (
                <li
                  key={index}
                  className={`rating-background ${isHovered ? "hovered" : ""}`}
            ...
            <div className="submit">
              <button
                className="sub"
                type="submit"
                onClick={() => setIsSubmit((prevSubmit) => !prevSubmit)}>
                Submit
              </button>
            </div>
          </div>
          ...
          <>
            <div className="box-1">
              ...
              <div className="feedback-text">
                <p>
                  You selected {""}
                  {ratings.findIndex((rating) => rating) + 1} out of 5
                </p>
              </div>
              <h1>Thank You!</h1>
